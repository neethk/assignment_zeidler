...
public class TestListener extends TestUtilities implements ITestListener, IAnnotationTransformer, IRetryAnalyzer, IReporter, StepLifecycleListener {

    private final AllureLifecycle allureLifecycle;
    public String testMethodName;
    Logger log = BaseTest.log;
    String testName;
    int counter = 0;
    int retryLimit = 2;
    ...
    private String reportTitle = "Cumulative Test Report By SDET";
...
//    }
    ...
    public void onTestFailure(ITestResult result) {
        ...
        Allure.addAttachment(testMethodName + formatter.format(date), saveScreenshot(testMethodName + formatter.format(date)));
        //save log on allure
    }

    @Attachment()
    public ByteArrayInputStream saveScreenshot(String whyIAmAttachingScreenshot) {
        //take screenshot
...
//        tableColumnStart("End<br/>Time");
        tableColumnStart("Run Time (hh:mm:ss)");
...
//        tableColumnStart("Excluded<br/>Groups");
        ...
        for (ISuite suite : suites) {
            ...
            for (ISuiteResult r : tests.values()) {
                ...
                summaryCell(System.getProperty("os.name", "generic").toLowerCase(Locale.ENGLISH), true);
                writer.println("</td>");
...
//                summaryCell(overview.getExcludedGroups());
    ...
    protected void startHtml(PrintWriter out) {
        ...
        out.println("<head>");
        out.println("<title>Custom Test Report</title>");
        ...
        out.println(".passedeven td {background-color: #90EE90}");
        out.println(".skippedodd td {background-color: #CCC}");
        out.println(".skippedodd td {background-color: #DDD}");
        out.println(".failedodd td,.numi_attn {background-color: #E9C8C8}");
        out.println(".failedeven td,.stripe .numi_attn {background-color: #E9C8C8}");
